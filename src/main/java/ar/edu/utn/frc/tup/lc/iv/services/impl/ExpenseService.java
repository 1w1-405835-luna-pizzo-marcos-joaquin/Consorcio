...
public class ExpenseService implements IExpenseService {
    ...
    /**
     * Saves an expense entity along with its installments and distributions.
     *
     * @param expenseModel The expense model to be saved.
     * @param expenseInstallmentModels The list of installment models associated with the expense.
     * @param expenseDistributionModels The list of distribution models associated with the expense.
     * @throws CustomException if required fields are missing in the ExpenseEntity.
     */
